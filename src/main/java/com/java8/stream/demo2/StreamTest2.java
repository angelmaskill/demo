...
public class StreamTest2 {
    ...
    public void filterEmployeesByCompany() {
        List<Employee> collect =
                getAllEmployees().stream().filter(e -> "上海公司".equals(e.getSubCompany())).collect(Collectors.toList());
    ...
    public void filterEmployeesThenGroup() {
        Map<String, List<Employee>> collect =
                getAllEmployees().stream().filter(employee -> "上海公司".equals(employee.getSubCompany())).collect(Collectors.groupingBy(Employee::getDepartment));
        System.out.println(collect);
    }
    ...
    public void calculateSum() {
        Integer collect =
                getAllEmployees().stream().filter(employee -> "上海公司".equals(employee.getSubCompany())).collect(Collectors.summingInt(Employee::getSalary));
        System.out.println(collect);
    }
    ...
    public void findHighestSalaryEmployee() {
        Optional<Employee> collect =
                getAllEmployees().stream().filter(employee -> "上海公司".equals(employee.getSubCompany())).max(Comparator.comparingInt(Employee::getSalary));
    ...
    public void groupAndCaculate() {
        Map<String, Long> collect =
                getAllEmployees().stream().collect(Collectors.groupingBy(employee -> employee.getSubCompany(),
                                                                         Collectors.counting()));
        System.out.println(collect);
    }
    ...
    public void partitionByCompanyAndDepartment() {
        Map<Boolean, Long> collect =
                getAllEmployees().stream().collect(Collectors.partitioningBy(e -> "上海公司".equals(e.getSubCompany()),
                                                                             Collectors.counting()));
        System.out.println(collect);
    }
    ...
    public void groupByCompanyAndDepartment() {
        Map<String, Map<String, Long>> collect =
                getAllEmployees().stream().collect(Collectors.groupingBy(e -> e.getSubCompany(),
    ...
    public void findHighestSalaryEmployee2() {
        Employee collect =
                getAllEmployees().stream().filter(e -> "上海公司".equals(e.getSubCompany())).collect(Collectors.collectingAndThen(Collectors.maxBy(Comparator.comparingInt(Employee::getSalary)), Optional::get));
        System.out.println(collect);
    }
}
