package com.netty.test9.dispatcher;

import com.netty.test9.domain.GameRequest;
import com.netty.test9.domain.GameResponse;
import com.netty.test9.domain.MessageQueue;
import com.netty.test9.handler.GameHandler;
import com.netty.test9.utils.ExceptionUtils;
import com.netty.test9.utils.HttpUtils;
...
public class HandlerDispatcher implements Runnable {
    ...
    public void addMessage(GameRequest request) {
        try {
            MessageQueue messageQueue = (MessageQueue) this.sessionMsgQ.get(Integer.valueOf(request.getChannel()
                    .hashCode()));
