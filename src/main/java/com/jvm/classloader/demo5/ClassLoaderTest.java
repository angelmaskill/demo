...
public class ClassLoaderTest {
	...
	public static void main(String[] args) throws Exception {
		...
		Class<?> clazz = myLoader.loadClass("com.jvm.classloader.demo5.ClassLoaderTest");
		...
		// 打印自定义的类加载器是被谁加载的.
		System.out.println("MyClassLoader loaded by : "+MyClassLoader.class.getClassLoader());
		/*
		 * 
		 ...
		 */
		System.out.println(obj instanceof com.jvm.classloader.demo5.ClassLoaderTest);
		...
		Thread.sleep(3000);
		// 获取CallClassLoader
		Class<?> clz = Class.forName("com.jvm.classloader.demo5.ClassLoaderTest");
