...
public class ClassFinder {
     ...
     * @param url      * @param recursive
     * @param classes
     */
    private void doScanPackageClassesByJAR(String baseName, URL url, boolean recursive, Set<Class<?>> classes) {
     ...
     * @param recursive
     */
    private void doScanPackageClassesByFile(Set<Class<?>> classes, String baseName, String filePath, boolean recursive) {
        ...
        for (File file : dirlist) {
            if (file.isDirectory()) {
                if ("".equals(baseName)) {
                    ...
                    doScanPackageClassesByFile(classes, baseName + "." + file.getName(), file.getAbsolutePath(),
                            recursive);
                }
            } else {
