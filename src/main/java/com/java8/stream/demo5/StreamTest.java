package com.java8.stream.demo5;
...
/**
 * @author ：yanlu.myl
 * @date ：Created in 2022-9-8 14:17
 * @description：
 * @modified By：
 * @version:
 */
...
// +--------------------+ +------+ +------+ +---+ +-------+
    public static void main(String args[]) {
        ...
        filterList =
                list.stream().filter(p -> null != p.getScore()).sorted(Comparator.comparing(UserPo::getScore).reversed()).collect(Collectors.toList());
