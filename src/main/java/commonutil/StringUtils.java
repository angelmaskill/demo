...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * @return
     */
    public static String getPayMerthantno() {
        String dateTimeNow = DateUtils.dateTime();
        return dateTimeNow + (int) (Math.random() * 900 + 100);
    }
    ...
    public static String createLinkString(JSONObject json, boolean writeNullValue) {
        ...
        for (String key : list) {
            ...
            if (writeNullValue && value instanceof JSONObject) {
                value = JSONObject.toJSONString(value, SerializerFeature.SortField, SerializerFeature.WriteMapNullValue);
            }
 ...
 /*   public static void main(String[] args) {
    ...
    public static JSONObject mapToJson(Map<String, ?> map) {
        ...
        for (Map.Entry<String, ?> entry : map.entrySet()) {
            ...
            if (value.startsWith("{") && value.endsWith("}")) {
                json.put(key, JSONObject.parseObject(value));
                continue;
            }
            json.put(key, value);
        }
    ...
    public static TreeMap<String, String> jsonToTreeMapString(JSONObject json) {
     ...
     * @return
     */
    public static TreeMap<String, String> xmlToTreeMap(String xmlStr) throws Exception {
        // SAX解析xml
        ...
        // 循环所有的一级元素放入map
        List<Element> xmlNameList = root.getChildren();
        TreeMap<String, String> treeMap = new TreeMap<>();
        for (Element e : xmlNameList) {
            treeMap.put(e.getName(), e.getValue());
        }
        return treeMap;
    }
    ...
    /**
     * @title 从map参数中获取第一个空值的key
     * @author TongZhaozhe
     * @date 2017年12月21日
     * @param paramMap
     * @return
     */
    public static String blankOfFirstKey(Map<String, String> paramMap) {
        ...
        while (entries.hasNext()) {
            ...
            if (org.apache.commons.lang3.StringUtils.isBlank(entry.getValue())) {
                return MessageFormat.format(ReturnMsgStatics.PARAMETER_CANNOT_EMPTY, entry.getKey());
            }
        }
        return null;
    }
