...
public class RedisAPI {
	...
	public static void main(String[] args) {
		...
		System.out.println(RedisClient5.getRedisClient().getShardedJedis());
		System.out.println(RedisClient5.getRedisClient().getJedis());
	...
	public void initConn() {
		redis = RedisClient5.getRedisClient().getJedis();
	}
