...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
     ...
     * @param dateFormate 日期格式化
     * @return
     */
    public static String getBeforeDate(int beforeDays,String dateFormate){
     ...
     * @return Date
     */
    public static Date parseRFC3339DateFormat(String date) {
        try {
            SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZ");
            String dts = date.replaceAll("([\\+\\-]\\d\\d):(\\d\\d)","$1$2");
