package com.redispri.demo7.redislock;
...
import com.redispri.demo7.AbstractLock;
import com.redispri.demo7.Lock;
import com.redispri.demo7.timerServer.TimeClient;
import com.redispri.demo7.util.ReadWriteLockInfo;
...
public class ReentrantReadWriteLock implements ReadWriteLock {
	...
	public java.util.concurrent.locks.Lock readLock() {
		return (java.util.concurrent.locks.Lock) readLock;
	}
	...
	public java.util.concurrent.locks.Lock writeLock() {
		return (java.util.concurrent.locks.Lock) writeLock;
	}
