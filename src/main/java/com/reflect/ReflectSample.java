/**
 * @(#)ReflectSample.java Copyright Oristand.All rights reserved.
...
public class ReflectSample {
    ...
    private static void newInstanceAndIncokeMethod() throws SecurityException, NoSuchMethodException,
